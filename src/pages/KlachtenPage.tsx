    ...
    try {
      ...
      successMessage.innerHTML = `
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="font-medium">Klacht succesvol ingediend!</div>
            <div class="text-sm">Ons team behandelt uw klacht en neemt zo spoedig mogelijk contact met u op.</div>
          </div>
        </div>
      `;
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Heeft u een klacht over een rijschool? Wij helpen u verder!
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <Card className="shadow-smooth">
                <CardHeader>
                  ...
                  <CardDescription>
                    Heeft u een klacht over een rijschool? Neem contact op, ook buiten kantooruren bereikbaar
                  </CardDescription>
                </CardHeader>
            ...
            <Card className="shadow-smooth">
              <CardHeader>
                ...
                <CardDescription>
                  Ons team behandelt uw klacht direct
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="onderwerp"
                      placeholder="Klacht over rijschool"
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="bericht"
                      placeholder="Beschrijf hier uw klacht..."
                      rows={5}
                      required
                    />
                  </div>
